(function($) {
        ...
        if (
          ...
          if ($window.width() > 991) {
            if ($window.scrollTop() >= 150) {
              $navBar.addClass('stick1');
            } else {
              $navBar.removeClass('stick1');
            }
  ...
  function initPhotoGallery() {
    ...
    $('.photo-gallery').on('click', '.gallery-item a', function(event) {
      ...
      template += '<div class="gallery-control gallery-prev"><a href="#" class="slick-prev"><i class="fa fa-arrow-left"></i></a></div>';
      template += '<div class="gallery-control gallery-next"><a href="#" class="slick-next"><i class="fa fa-arrow-right"></i></a></div>';
      template += '</div>';
