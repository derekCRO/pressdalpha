class Admin::BlogCategoriesController < Admin::BaseAdminController
  ...
  def create
    ...
    respond_to do |format|
      if @blog_category.save
        format.html { redirect_to '/admin/blog_categories/', notice: 'Blog Catgeory was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @blog_category.update(blog_category_params)
        format.html { redirect_to '/admin/blog_categories/', notice: 'Blog Catgeory was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to '/admin/blog_categories/', notice: 'Blog Catgeory was successfully destroyed.' }
  ...
  private
    ...
    def blog_category_params
      params.require(:blog_category).permit(:name, :is_active)
    end
end
