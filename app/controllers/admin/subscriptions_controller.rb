  ...
  def create
    ...
    respond_to do |format|
      if @subscription.save
        format.html { redirect_to admin_subscription_list_manual_path, notice: 'Subscription was successfully created.' }
        format.json { render :show, status: :created, location: @subscription }
        format.js { redirect_to admin_subscription_list_manual_path, notice: 'Subscription was successfully created.' }
      else
